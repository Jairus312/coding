...
class RestaurantOrderManagement:
    ...
    def setup_background(self, root):
        ...
        canvas.pack()
        original_image = tk.PhotoImage(file="C:\Users\didde\OneDrive\Desktop\coding\images\DJ project (2).png")
        background_image = original_image.subsample(
            original_image.width(10) // bg_width,
            original_image.height(40) // bg_height)
        canvas.create_image(0, 0, anchor=tk.NW, image="C:\Users\didde\OneDrive\Desktop\coding\images\DJ project (2).png")
        canvas.image ="C:\Users\didde\OneDrive\Desktop\coding\images\DJ project (2).png"
